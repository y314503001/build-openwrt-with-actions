...
echo 'src-git easytier https://github.com/y314503001/luci-app-easytier' >>feeds.conf.default
echo 'src-git lucky https://github.com/y314503001/luci-app-lucky' >>feeds.conf.default
